...
public class CondicionalController {
	...
	public ResponseEntity<String> simularValores(@RequestParam(name = "idade") int idade) {
		/*
		 * Elabore um algoritmo para dizer a partir da idade se a pessoa tem mais ou
		 * menos do que 18 anos.
		 * 
		...
		if (idade == 18) {
			...
			returnIdade = "Você tem " + idade + " anos. Possui mais de 18 anos";
		} else {
			returnIdade = "Você tem " + idade + " anos. Possui menos de 18 anos";
		}

		return ResponseEntity.ok(returnIdade);
	}
